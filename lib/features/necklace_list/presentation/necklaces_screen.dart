...
class _NecklacesScreenState extends State<NecklacesScreen> {
  final List<Necklace> _necklaces = [
    Necklace(
      ...
      emission1Duration: Duration(minutes: 10),
      releaseInterval1: Duration(minutes: 20),
      emission2Duration: Duration(minutes: 15),
      releaseInterval2: Duration(minutes: 30),
    ),
    Necklace(
      id: '2',
      name: 'Ocean Breeze',
      ...
      periodicEmissionEnabled: true,
      emission1Duration: Duration(minutes: 5),
      releaseInterval1: Duration(minutes: 10),
      emission2Duration: Duration(minutes: 10),
      releaseInterval2: Duration(minutes: 20),
    ),
    Necklace(
      id: '3',
      name: 'Forest Mist',
